...
#        compteur = scene.frame_current % len(chemins_coords[chemin_temp-1])
        ...
        compteur+=1
        bpy.data.objects['Cube'].location = chemins_coords[chemin_temp-1][compteur-1]
        compteur=compteur%len(chemins_coords[chemin_temp-1])
        bpy.data.objects['Cube'].rotation_euler = (
...
chemin_temp, noeud_next, chemin_sens,poubelle= choix_chemin(chemin_temp, noeud_temp)
